...
Singleton {
    ...
    readonly property real radiusExtraSmall: rounded(4)
    ...
    readonly property real spaceExtraSmall: scaled(4)
    readonly property real spaceSmall: scaled(8)
    readonly property real spaceMedium: scaled(12)
    readonly property real spaceLarge: scaled(16)
    readonly property real spaceExtraLarge: scaled(24)
    readonly property real spaceHuge: scaled(32)
    readonly property real compactControlHeight: scaled(40)
    readonly property real minimumHitSize: scaled(40)
    readonly property real iconSmall: scaled(16)
    readonly property real iconMedium: scaled(20)
    readonly property real iconLarge: scaled(24)
